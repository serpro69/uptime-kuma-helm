...
Fork of https://github.com/serpro69/uptime-kuma-helm/

image:https://github.com/serpro69/uptime-kuma-helm/actions/workflows/container-build.yaml/badge.svg[🏗️ Container Image Build, link="https://github.com/serpro69/uptime-kuma-helm/actions/workflows/container-build.yaml"]
image:https://img.shields.io/maintenance/yes/2026[Maintenance]
image:https://img.shields.io/github/license/serpro69/uptime-kuma-helm[GitHub]
...
----
helm repo add k3 https://serpro69.github.io/uptime-kuma-helm/
helm repo update
----
...
helm install test-uptime k3/uptime-kuma --version 2.0.0
----
...
I published a prebuilt version of this to link:https://quay.io/repository/serpro69/uptime-kuma?tab=info[Quay.io] and reference that within the Chart, feel free to use that or build it yourself :wink:.

Alternatively, the image is also pushed to link:https://github.com/serpro69/uptime-kuma-helm/pkgs/container/uptime-kuma[ghcr.io] (GitHub Container registry) so there is a backup mirror when you run into issues with Quay.
